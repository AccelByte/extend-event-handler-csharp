...
> :bulb: The Dev Container automatically installs .NET 8 SDK and all required dependencies.
...
> :bulb: GitHub Codespaces uses the same Dev Container configuration, so you'll get .NET 8 SDK and all dependencies automatically installed.
